                    ...
                    <form action="">
                        ...
                        <div className="border-b border-gray-900/10 pb-12">
                            ...
                            <ul role="list" className="divide-y divide-gray-400">
                                {addesses.map((address) => (
                                    <li key={address.email} htmlFor={addesses.pincode} className="flex justify-between gap-x-6 py-5 px-2 rounded-sm">
                                                ...
                                                <li key={product.id} className="flex py-6">
                                                    ...
                                                    <div className="ml-4 flex flex-1 flex-col">
                                                        ...
                                                        <div className="flex flex-1 items-end justify-between text-sm">
                                                            ...
                                                            <label className='text-gray-500' for="qty">Qty </label>
